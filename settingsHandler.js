...
let argsSchema = Object.entries({
    ...
    "--allowedCommandsForChatable": "allowedCommandsForChatable",
...
let defaults = {
    ...
    "disabledCommand": "\x1b[31m[@${username}] That command is not allowed on discord\x1b[0m",
    ...
    "allowedCommandsForChatable": ["list"],
    "delay": 1500,
    "header": "```ansi\n",
    "footer": "\n```",
    "maxlength": 2000,
